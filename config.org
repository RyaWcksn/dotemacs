...
#+RESULTS:
| %e | mode-line-front-space | mode-line-mule-info | mode-line-client | mode-line-modified | mode-line-remote | mode-line-frame-identification | mode-line-buffer-identification |   | mode-line-position | (:eval (if vc-mode (let* ((noback (replace-regexp-in-string (format ^ %s (vc-backend buffer-file-name))   vc-mode)) (face (cond ((string-match ^ - noback) 'mode-line-vc) ((string-match ^ [:@] noback) 'mode-line-vc-edit) ((string-match ^ [!\?] noback) 'mode-line-vc-modified)))) (format  %s (substring noback 2))))) |   | mode-line-misc-info | mode-line-end-spaces |
...
#+RESULTS:
: [nil 0 20 0 nil require (blamer nil t) idle 0 nil]
