...
#+RESULTS:
| /Users/senja/Android/platform-tools/ | /Users/senja/Android/cmdline-tools/tools/bin/ | /usr/local/opt/openvpn/sbin | /usr/local/Caskroom/google-cloud-sdk/latest/google-cloud-sdk/bin | /usr/local/opt/php@7.3/bin | /Users/senja/Android/platform-tools/ | /Users/senja/Android/cmdline-tools/tools/bin/ | /usr/local/opt/openvpn/sbin | /usr/local/Caskroom/google-cloud-sdk/latest/google-cloud-sdk/bin | /usr/local/opt/php@7.3/bin | /usr/local/opt/openvpn/sbin | /usr/local/Caskroom/google-cloud-sdk/latest/google-cloud-sdk/bin | /usr/local/opt/php@7.3/bin | /usr/local/bin | /opt/X11/bin | /Library/Apple/usr/bin | /usr/local/Cellar/go/1.19.3/libexec/bin | /Users/senja/go/bin | /usr/bin | /bin | /usr/sbin | /sbin | /usr/local/Cellar/go/1.19.3/libexec//bin | /Users/senja/go/bin | /Users/senja/Android/flutter/bin/ | /usr/local/Cellar/go/1.19.3/libexec//bin | /Users/senja/go/bin | /Users/senja/Android/flutter/bin/ | /Users/senja/Android/platform-tools/ | /Users/senja/Android/cmdline-tools/tools/bin/ | /usr/local/opt/openvpn/sbin | /usr/local/Caskroom/google-cloud-sdk/latest/google-cloud-sdk/bin | /usr/local/opt/php@7.3/bin | /usr/local/opt/openvpn/sbin | /usr/local/Caskroom/google-cloud-sdk/latest/google-cloud-sdk/bin | /usr/local/opt/php@7.3/bin | /usr/local/bin | /opt/X11/bin | /Library/Apple/usr/bin | /usr/local/Cellar/go/1.19.3/libexec/bin | /Users/senja/go/bin | /usr/bin | /bin | /usr/sbin | /sbin | /usr/local/Cellar/go/1.19.3/libexec//bin | /Users/senja/go/bin | /Users/senja/Android/flutter/bin/ | /usr/local/opt/openvpn/sbin | /usr/local/Caskroom/google-cloud-sdk/latest/google-cloud-sdk/bin | /usr/local/opt/php@7.3/bin | /usr/local/bin | /opt/X11/bin | /Library/Apple/usr/bin | /usr/local/Cellar/go/1.19.3/libexec/bin | /Users/senja/go/bin | /usr/bin | /bin | /usr/sbin | /sbin | /usr/local/Cellar/emacs-plus@28/28.2/libexec/emacs/28.2/x86_64-apple-darwin20.4.0 |
...
#+RESULTS:
| lsp-deffered | company-mode | tree-sitter-hl-mode | flycheck-golangci-lint-setup | lsp-go-install-save-hooks | yas-minor-mode | lsp-deferred | doom-modeline-env-setup-go |
...
#+RESULTS:
| assignment | \documentclass[11pt,a4paper]{article} |
